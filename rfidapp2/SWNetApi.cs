...
namespace RFID
{
    public class SWNetApi
    {
        ...
        */
        ...
        [DllImport("SWNetApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool SWNet_ReadWhiteListCnt(byte bDevAdr, out ushort piWhiteListNum);

        [DllImport("SWNetApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool SWNet_ReadWhiteList(byte bDevAdr, ushort iNum, byte[] pList);

        [DllImport("SWNetApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool SWNet_WriteWhiteList(byte bDevAdr, byte[] pList, byte bLength);

        [DllImport("SWNetApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool SWNet_DelAllWhiteList(byte bDevAdr);

        [DllImport("SWNetApi.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool SWNet_DelOneWhiteList(byte bDevAdr, byte[] pList, byte bLength);
    }
}
